...
// FAKE ALWAYS LOGGED IN(TEMPRORY PURPOSE):
...
console.log(Number.parseInt('px46', 10)); //output will be NaN
...
// isFinite: Check if a value is a number 
...
console.log(new Date(2023, 8, 14, 15, 23, 5));
